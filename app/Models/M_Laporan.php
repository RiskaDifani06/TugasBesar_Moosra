...
class M_Laporan extends Model
{
    ...
    public static function normalisasi() {
        ...
        foreach ($penilaian as $pen) {
            ...
            $bagi6 += pow($pen->sub_kriteria5->nilai, 2);
            $bagi7 += pow($pen->sub_kriteria5->nilai, 2);
            $bagi8 += pow($pen->sub_kriteria5->nilai, 2);
            $bagi9 += pow($pen->sub_kriteria5->nilai, 2);
            $bagi10 += pow($pen->sub_kriteria5->nilai, 2);
        }
        ...
        if ($pembagi1 == 0 || $pembagi2 == 0 || $pembagi3 == 0 || $pembagi4 == 0 || $pembagi5 == 0 || $pembagi6 == 0
        || $pembagi7 == 0 || $pembagi8 == 0 || $pembagi9 == 0 || $pembagi10 == 0 ) {
            return [
                $pembagi1 = 1,
                $pembagi2 = 1,
                $pembagi3 = 1,
